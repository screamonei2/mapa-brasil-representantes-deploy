...
# -*- coding: utf-8 -*-
"""
Script para adicionar as cidades da região Jequitinhonha ao representante 48,
junto com as cidades das regiões Norte e Central de Minas que já estão lá.
"""
...
def obter_cidades_regioes_48(mesorregioes):
    ...
    regioes_48 = ["Norte de Minas", "Central Mineira", "Jequitinhonha"]
    cidades_48 = []
...
def atualizar_representante_48(representantes, cidades_regioes_48):
    """Atualiza o representante 48 com as cidades das regiões Norte, Central e Jequitinhonha de Minas."""
    ...
    # Cidades que devem ser adicionadas (da região Jequitinhonha que não estão)
    ...
    # Define as cidades corretas (regiões Norte, Central e Jequitinhonha de Minas)
...
def salvar_arquivo(representantes):
    ...
    # Cria backup
    backup_path = 'data/representantes_por_estado_backup_jequitinhonha_48.json'
...
def main():
    """Função principal."""
    print("=== ADIÇÃO DA REGIÃO JEQUITINHONHA AO REPRESENTANTE 48 ===")
    ...
    try:
        ...
        # Obtém as cidades das regiões Norte, Central e Jequitinhonha de Minas
        cidades_regioes_48 = obter_cidades_regioes_48(mesorregioes)
        print(f"✓ Identificadas {len(cidades_regioes_48)} cidades das regiões Norte, Central e Jequitinhonha de Minas")
        ...
        if atualizar_representante_48(representantes, cidades_regioes_48):
            ...
            print("✓ Regiões atendidas: Norte de Minas + Central Mineira + Jequitinhonha")
        else:
            print("\n✗ Erro na atualização!")

...
# -*- coding: utf-8 -*-
"""
Script para adicionar as cidades da região Vale do Mucuri ao representante 48,
junto com as cidades das regiões Norte, Central e Jequitinhonha de Minas que já estão lá.
"""
...
def obter_cidades_regioes_48(mesorregioes):
    ...
    regioes_48 = ["Norte de Minas", "Central Mineira", "Jequitinhonha", "Vale do Mucuri"]
    cidades_48 = []
...
def atualizar_representante_48(representantes, cidades_regioes_48):
    """Atualiza o representante 48 com as cidades das regiões Norte, Central, Jequitinhonha e Vale do Mucuri de Minas."""
    ...
    # Cidades que devem ser adicionadas (da região Vale do Mucuri que não estão)
    ...
    # Define as cidades corretas (regiões Norte, Central, Jequitinhonha e Vale do Mucuri de Minas)
...
def salvar_arquivo(representantes):
    ...
    # Cria backup
    backup_path = 'data/representantes_por_estado_backup_vale_mucuri_48.json'
...
def main():
    """Função principal."""
    print("=== ADIÇÃO DA REGIÃO VALE DO MUCURI AO REPRESENTANTE 48 ===")
    ...
    try:
        ...
        # Obtém as cidades das regiões Norte, Central, Jequitinhonha e Vale do Mucuri de Minas
        cidades_regioes_48 = obter_cidades_regioes_48(mesorregioes)
        print(f"✓ Identificadas {len(cidades_regioes_48)} cidades das regiões Norte, Central, Jequitinhonha e Vale do Mucuri de Minas")
        ...
        if atualizar_representante_48(representantes, cidades_regioes_48):
            ...
            print("✓ Regiões atendidas: Norte + Central + Jequitinhonha + Vale do Mucuri")
        else:
            print("\n✗ Erro na atualização!")

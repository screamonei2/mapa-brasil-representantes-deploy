...
# -*- coding: utf-8 -*-
"""
Script para adicionar as cidades da região Oeste de Minas ao representante 48,
...
def obter_cidades_regioes_48(mesorregioes):
    ...
    regioes_48 = ["Norte de Minas", "Central Mineira", "Jequitinhonha", "Vale do Mucuri", "Vale do Rio Doce", "Metropolitana de Belo Horizonte", "Oeste de Minas"]
    cidades_48 = []
...
def atualizar_representante_48(representantes, cidades_regioes_48):
    ...
    # Cidades que devem ser adicionadas (da região Oeste de Minas que não estão)
...
def salvar_arquivo(representantes):
    ...
    # Cria backup
    backup_path = 'data/representantes_por_estado_backup_oeste_minas_48.json'
...
def main():
    """Função principal."""
    print("=== ADIÇÃO DA REGIÃO OESTE DE MINAS AO REPRESENTANTE 48 ===")
    ...
    try:
        ...
        if atualizar_representante_48(representantes, cidades_regioes_48):
            ...
            print("✓ Regiões atendidas: Norte + Central + Jequitinhonha + Vale do Mucuri + Vale do Rio Doce + Metropolitana de Belo Horizonte + Oeste de Minas")
        else:
            print("\n✗ Erro na atualização!")

...
# -*- coding: utf-8 -*-
"""
Script para adicionar as cidades da região Central Mineira ao representante 48,
junto com as cidades da região Norte de Minas que já estão lá.
"""
...
def obter_cidades_regioes_48(mesorregioes):
    ...
    regioes_48 = ["Norte de Minas", "Central Mineira"]
    cidades_48 = []
...
def atualizar_representante_48(representantes, cidades_regioes_48):
    """Atualiza o representante 48 com as cidades das regiões Norte e Central de Minas."""
    ...
    # Cidades que devem ser adicionadas (da região Central Mineira que não estão)
    ...
    # Define as cidades corretas (regiões Norte e Central de Minas)
...
def salvar_arquivo(representantes):
    ...
    # Cria backup
    backup_path = 'data/representantes_por_estado_backup_central_minas_48.json'
...
def main():
    """Função principal."""
    print("=== ADIÇÃO DA REGIÃO CENTRAL MINEIRA AO REPRESENTANTE 48 ===")
    ...
    try:
        ...
        # Obtém as cidades das regiões Norte e Central de Minas
        cidades_regioes_48 = obter_cidades_regioes_48(mesorregioes)
        print(f"✓ Identificadas {len(cidades_regioes_48)} cidades das regiões Norte e Central de Minas")
        ...
        if atualizar_representante_48(representantes, cidades_regioes_48):
            ...
            print("✓ Regiões atendidas: Norte de Minas + Central Mineira")
        else:
            print("\n✗ Erro na atualização!")

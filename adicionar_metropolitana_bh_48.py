...
# -*- coding: utf-8 -*-
"""
Script para adicionar as cidades da região Metropolitana de Belo Horizonte ao representante 48,
...
def obter_cidades_regioes_48(mesorregioes):
    ...
    regioes_48 = ["Norte de Minas", "Central Mineira", "Jequitinhonha", "Vale do Mucuri", "Vale do Rio Doce", "Metropolitana de Belo Horizonte"]
    cidades_48 = []
...
def atualizar_representante_48(representantes, cidades_regioes_48):
    """Atualiza o representante 48 com as cidades das regiões Norte, Central, Jequitinhonha, Vale do Mucuri, Vale do Rio Doce e Metropolitana de Belo Horizonte de Minas."""
    ...
    # Cidades que devem ser adicionadas (da região Metropolitana de Belo Horizonte que não estão)
...
def salvar_arquivo(representantes):
    ...
    # Cria backup
    backup_path = 'data/representantes_por_estado_backup_metropolitana_bh_48.json'
...
def main():
    """Função principal."""
    print("=== ADIÇÃO DA REGIÃO METROPOLITANA DE BELO HORIZONTE AO REPRESENTANTE 48 ===")
    ...
    try:
        ...
        if atualizar_representante_48(representantes, cidades_regioes_48):
            ...
            print("✓ Regiões atendidas: Norte + Central + Jequitinhonha + Vale do Mucuri + Vale do Rio Doce + Metropolitana de Belo Horizonte")
        else:
            print("\n✗ Erro na atualização!")
